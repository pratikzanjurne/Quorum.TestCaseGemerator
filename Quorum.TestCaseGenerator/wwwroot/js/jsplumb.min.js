(function () {
    ...
    function d(a, b, d, e) {
        var f, g, h = b / a,
            ...
            n = [];
        if (m >= 0) f = c(l + Math.sqrt(m)) * Math.pow(Math.abs(l + Math.sqrt(m)), 1 / 3), g = c(l - Math.sqrt(m)) * Math.pow(Math.abs(l - Math.sqrt(m)), 1 / 3), n[0] = -h / 3 + (f + g), n[1] = -h / 3 - (f + g) / 2, n[2] = -h / 3 - (f + g) / 2, 0 !== Math.abs(Math.sqrt(3) * (f - g) / 2) && (n[1] = -1, n[2] = -1);
        else {
    ...
    var e = {
        ...
        j = function (a, b) {
            for (var c = b.length - 1, d = 2 * c - 1, f = [], g = [], h = [], i = [], j = [
                [1, .6, .3, .1],
                [.4, .6, .6, .4],
                [.1, .3, .6, 1]
            ], k = 0; c >= k; k++) f[k] = e.subtract(b[k], a);
            for (var k = 0; c - 1 >= k; k++) g[k] = e.subtract(b[k + 1], b[k]), g[k] = e.scale(g[k], 3);
            for (var l = 0; c - 1 >= l; l++)
                for (var m = 0; c >= m; m++) h[l] || (h[l] = []), h[l][m] = e.dotProduct(g[l], f[m]);
            for (k = 0; d >= k; k++) i[k] || (i[k] = []), i[k].y = 0, i[k].x = parseFloat(k) / d;
        ...
        r = function (a, b) {
            for (var c = q(a.length - 1), d = 0, e = 0, f = 0; f < a.length; f++) d += a[f].x * c[f](b), e += a[f].y * c[f](b);
            return {
                x: d,
                y: e
            }
        ...
        u = function (a, b, c) {
            ...
            for (var d = r(a, b), e = 0, f = b, g = c > 0 ? 1 : -1, h = null; e < Math.abs(c);) f += .005 * g, h = r(a, f), e += s(h, d), d = h;
            return {
                point: h,
                location: f
            }
        ...
        v = function (a) {
            ...
            if (t(a)) return 0;
            for (var c = r(a, 0), d = 0, e = 0, f = 1, g = null; 1 > e;) e += .005 * f, g = r(a, e), d += s(g, c), c = g;
            return console.log("length", (new Date).getTime() - b), d
        },
        w = function (a, b, c) {
                ...
                return function (b, c, d, f) {
                    if (!b.__tamee) {
                        ...
                        var h = function (c) {
                            ...
                            i = function (c) {
                                for (var d = g(c), f = 0; f < a.length; f++) d != a[f] || e(c.relatedTarget || c.toElement, "*", d) || (d.__tamee.over = !1, a.splice(f, 1), s("mouseexit", c, b, d))
                            };
            ...
            H = function (a, b, c) {
                null != c && I(a, function () {
                    ...
                    if (l(d, b, c), null != c.__tauid)
                        if (d.removeEventListener) d.removeEventListener(b, c, !1), u && w[b] && d.removeEventListener(w[b], c, !1);
    ...
    function () {
        ...
        var a = this,
            ...
            F = function (a, b, c, d) {
                ...
                var j, m, n, p, q, s, t = [0, 0],
                    u = null,
                    w = null,
                    y = [0, 0],
                    A = !1,
                    F = [0, 0],
                    G = this.params.consumeStartEvent !== !1,
                    J = this.el,
                    K = this.params.clone,
                    L = (this.params.scroll, b.multipleDrop !== !1),
                    M = !1,
                    N = null,
                    O = [],
                    P = null,
                    Q = b.ghostProxyParent;
                if (j = b.ghostProxy === !0 ? D : b.ghostProxy && "function" == typeof b.ghostProxy ? b.ghostProxy : function (a, b) {
                    return P && P.useGhostProxy ? P.useGhostProxy(a, b) : !1
                }, m = b.makeGhostProxy ? b.makeGhostProxy : function (a) {
                    return P && P.makeGhostProxy ? P.makeGhostProxy(a) : a.cloneNode(!0)
                }, b.selector) {
                ...
                var X, Y = function (a, b, c, d) {
                    return null != P && P.constrain && "function" == typeof P.constrain ? P.constrain(a, b, c, d) : U(a, b, c, d)
                };
                ...
                var Z = function (a) {
                    ...
                    aa = this.setFilter = function (b, c) {
                        if (b) {
                            var d = Z(b);
                            $[d] = [function (c) {
                ...
                this.addFilter = aa, this.removeFilter = function (a) {
                ...
                this.addSelector = function (a) {
                    ...
                    if (!a.defaultPrevented) {
                        ...
                        if (b && this.isEnabled() && this.canDrag()) {
                            ...
                            if (d) {
                                ...
                                if (K)
                                    if (J = N.cloneNode(!0), this.params.addClass(J, r.clonedDrag), J.setAttribute("id", null), J.style.position = "absolute", null != this.params.parent) {
                                        var g = this.params.getPosition(this.el);
                                        J.style.left = g[0] + "px", J.style.top = g[1] + "px", this.params.parent.appendChild(J)
                                    } else {
                                        var j = f(N);
                                        J.style.left = j.left + "px", J.style.top = j.top + "px", document.body.appendChild(J)
                                    }
                                else J = N;
                                G && z(a), t = o(a), J && J.parentNode && (F = [J.parentNode.scrollLeft, J.parentNode.scrollTop]), this.params.bind(document, "mousemove", this.moveListener), this.params.bind(document, "mouseup", this.upListener), h.markSelection(this), h.markPosses(this), this.params.addClass(document.body, c.noSelect), fa("beforeStart", {
                                    el: this.el,
                                    pos: u,
                                    e: a,
                                    drag: this
                    ...
                    if (t) {
                        ...
                        if (t) {
                            ...
                            J && J.parentNode && (d += J.parentNode.scrollLeft - F[0], e += J.parentNode.scrollTop - F[1]), d /= f, e /= f, this.moveBy(d, e, a), h.updateSelection(d, e, this), h.updatePosses(d, e, this)
                        }
                    }
                }.bind(this), this.upListener = function (a) {
                    t && (t = null, this.params.unbind(document, "mousemove", this.moveListener), this.params.unbind(document, "mouseup", this.upListener), this.params.removeClass(document.body, c.noSelect), this.unmark(a), h.unmarkSelection(this, a), h.unmarkPosses(this, a), this.stop(a), h.notifyPosseDragStop(this, a), A = !1, da.length = 0, K ? (J && J.parentNode && J.parentNode.removeChild(J), J = null) : X && X(J, this.params.getPosition(J)) === !0 && (this.params.setPosition(J, u), fa("revert", J)))
                }.bind(this), this.getFilters = function () {
                    return $
                }, this.abort = function () {
                    null != t && this.upListener()
                }, this.getDragElement = function (a) {
                    return a ? N || this.el : J || this.el
                };
                var ea = {
                    start: [],
                    drag: [],
                ...
                b.events.start && ea.start.push(b.events.start), b.events.beforeStart && ea.beforeStart.push(b.events.beforeStart), b.events.stop && ea.stop.push(b.events.stop), b.events.drag && ea.drag.push(b.events.drag), b.events.revert && ea.revert.push(b.events.revert), this.on = function (a, b) {
                    ea[a] && ea[a].push(b)
                }, this.off = function (a, b) {
                    if (ea[a]) {
                        for (var c = [], d = 0; d < ea[a].length; d++) ea[a][d] !== b && c.push(ea[a][d]);
                        ea[a] = c
                    }
                };
                var fa = function (a, b) {
                    ...
                    if (P && P[a]) c = P[a](b);
                        ...
                        for (var d = 0; d < ea[a].length; d++) try {
                            var e = ea[a][d](b);
                            null != e && (c = e)
                        } catch (f) { }
                    return c
                ...
                this.notifyStart = function (a) {
                    ...
                    u = this.params.getPosition(J), w = this.params.getPosition(J, !0), y = [w[0] - u[0], w[1] - u[1]], this.size = this.params.getSize(J), ca = h.getMatchingDroppables(this), x(ca, !0, !1, this), this.params.addClass(J, this.params.dragClass || c.drag);
                    var b;
                    b = this.params.getConstrainingRectangle ? this.params.getConstrainingRectangle(J) : this.params.getSize(J.parentNode), ba = {
                        w: b[0],
                        h: b[1]
                    }, q = 0, s = 0, a && h.notifySelectionDragStart(this)
                };
                var ga;
                this.unmark = function (a, d) {
                    if (x(ca, !1, !0, this), M && j(N, J) ? (ga = [J.offsetLeft - q, J.offsetTop - s], J.parentNode.removeChild(J), J = N) : ga = null, this.params.removeClass(J, this.params.dragClass || c.drag), ca.length = 0, M = !1, !d) {
                        da.length > 0 && ga && b.setPosition(N, ga), da.sort(I);
                        for (var e = 0; e < da.length; e++) {
                            var f = da[e].drop(this, a);
                            if (f === !0) break
                        }
                    }
                }, this.moveBy = function (a, c, d) {
                    da.length = 0;
                    var e = this.toGrid([u[0] + a, u[1] + c]),
                        f = Y(e, J, ba, this.size);
                    if (j(this.el, J))
                        if (e[0] !== f[0] || e[1] !== f[1]) {
                            if (!M) {
                                var g = m(N);
                                b.addClass(g, r.ghostProxy), Q ? (Q.appendChild(g), n = b.getPosition(N.parentNode, !0), p = b.getPosition(b.ghostProxyParent, !0), q = n[0] - p[0], s = n[1] - p[1]) : N.parentNode.appendChild(g), J = g, M = !0
                            }
                            f = e
                        } else M && (J.parentNode.removeChild(J), J = N, M = !1, n = null, p = null, q = 0, s = 0);
                    var h = {
                        x: f[0],
                        y: f[1],
                        w: this.size[0],
                        ...
                        k = null;
                    this.params.setPosition(J, [f[0] + q, f[1] + s]);
                    for (var l = 0; l < ca.length; l++) {
                        var o = {
                            x: ca[l].pagePosition[0],
                            y: ca[l].pagePosition[1],
                            w: ca[l].size[0],
                            h: ca[l].size[1]
                        };
                        this.params.intersects(i, o) && (L || null == k || k === ca[l].el) && ca[l].canDrop(this) ? (k || (k = ca[l].el), da.push(ca[l]), ca[l].setHover(this, !0, d)) : ca[l].isHover() && ca[l].setHover(this, !1, d)
                    }
                    fa("drag", {
                        el: this.el,
                        pos: f,
                ...
                }, this.params.bind(this.el, "mousedown", this.downListener), this.params.handle ? aa(this.params.handle, !1) : aa(this.params.filter, this.params.filterExclude)
            },
            G = function (a, b, c, d) {
        ...
        a.Katavorio = function (a) {
            ...
            var h = 1,
                ...
                k = (this.getMatchingDroppables = function (a) {
                    for (var b = [], c = {}, d = 0; d < a.scopes.length; d++) {
                        ...
                        if (e)
                            for (var f = 0; f < e.length; f++) !e[f].canDrop(a) || c[e[f].uuid] || !e[f].allowLoopback && e[f].el === a.el || (c[e[f].uuid] = !0, b.push(e[f]))
                    }
                    return b.sort(I), b
                }, function (b) {
                    b = b || {};
                    ...
                    for (c in a) d[c] = a[c];
                    for (c in b) d[c] = b[c];
                    for (c = 0; c < t.length; c++) d.events[t[c]] = b[t[c]] || u;
                    return d.katavorio = this, d
                }.bind(this)),
                l = function (a, b) {
                    for (var c = 0; c < t.length; c++) b[t[c]] && a.on(t[c], b[t[c]])
                }.bind(this),
                m = {},
                n = a.css || {},
                o = a.scope || s;
            ...
            y(["set", "add", "remove", "toggle"], function (a) {
                ...
                for (var c in this._dragsByScope) w(this._dragsByScope[c], function (c) {
                    c.snap(a, b)
                })
            ...
            this.elementRemoved = function (a) {
                a._katavorioDrag && this.destroyDraggable(a), a._katavorioDrop && this.destroyDroppable(a)
            ...
            this.addToPosse = function (a, b) {
                ...
                for (var d = 1; d < arguments.length; d++) b = arguments[d], y(a, function (a) {
    ...
    function () {
        ...
        function l(b, e, g, h) {
            ...
            for (j in e)
                ...
                else if (c(e[j]) || d(e[j])) l[j] ? (i = [], i.push.apply(i, a(n[j]) ? n[j] : [n[j]]), i.push.apply(i, d(e[j]) ? e[j] : [e[j]]), n[j] = i) : n[j] = e[j];
                else if (a(e[j])) i = [], a(n[j]) && i.push.apply(i, n[j]), i.push.apply(i, e[j]), n[j] = i;
                else if (f(e[j])) {
                    f(n[j]) || (n[j] = {});
        ...
        function w() {
            ...
            return H[255 & a] + H[a >> 8 & 255] + H[a >> 16 & 255] + H[a >> 24 & 255] + "-" + H[255 & b] + H[b >> 8 & 255] + "-" + H[b >> 16 & 15 | 64] + H[b >> 24 & 255] + "-" + H[63 & c | 128] + H[c >> 8 & 255] + "-" + H[c >> 16 & 255] + H[c >> 24 & 255] + H[255 & d] + H[d >> 8 & 255] + H[d >> 16 & 255] + H[d >> 24 & 255]
        }
        ...
        function B() {
            ...
            if (G.logEnabled && "undefined" != typeof console) try {
        ...
        function D(a, b, c) {
            var d = [a[0] - b[0], a[1] - b[1]],
                e = Math.cos(c / 360 * Math.PI * 2),
                f = Math.sin(c / 360 * Math.PI * 2);
            return [d[0] * e - d[1] * f + b[0], d[1] * e + d[0] * f + b[1], e, f]
        }
        ...
        var F = this;
        F.jsPlumbUtil = F.jsPlumbUtil || {};
        var G = F.jsPlumbUtil;
        "undefined" != typeof exports && (exports.jsPlumbUtil = G), G.isArray = a, G.isNumber = b, G.isString = c, G.isBoolean = d, G.isNull = e, G.isObject = f, G.isDate = g, G.isFunction = h, G.isNamedFunction = i, G.isEmpty = j, G.clone = k, G.merge = l, G.replace = m, G.functionChain = n, G.populate = o, G.findWithFunction = p, G.removeWithFunction = q, G.remove = r, G.addWithFunction = s, G.addToList = t, G.suggest = u, G.extend = v;
        for (var H = [], I = 0; 256 > I; I++) H[I] = (16 > I ? "0" : "") + I.toString(16);
        G.uuid = w, G.fastTrim = x, G.each = y, G.map = z, G.mergeWithParents = A, G.logEnabled = !0, G.log = B, G.wrap = C;
        var J = function () {
            function a() {
                var a = this;
        ...
        G.EventGenerator = J, G.rotatePoint = D, G.rotateAnchorOrientation = E
    }.call("undefined" != typeof window ? window : this),
    function () {
        "use strict";
        var a = this;
    ...
    function () {
        var a = {
            ...
            b = this,
            c = function (a, b) {
                this.count = 0, this.instance = a, this.lists = {}, this.options = b || {}, this.instance.addList = function (a, b) {
                    ...
                    for (var b = this.instance.getSelector(a.el, "[jtk-scrollable-list]"), c = 0; c < b.length; c++) this.addList(b[c])
        ...
        b.jsPlumbListManager = c, c.prototype = {
            addList: function (b, c) {
                ...
                this.instance.extend(e, this.options), c = this.instance.extend(e, c || {});
        ...
        var d = function (a, b, c, d) {
            ...
            var h = function (c) {
                for (var d = a.getSelector(b, ".jtk-managed"), h = a.getId(b), i = 0; i < d.length; i++) {
                    if (d[i].offsetTop < b.scrollTop) d[i]._jsPlumbProxies || (d[i]._jsPlumbProxies = d[i]._jsPlumbProxies || [], a.select({
                    ...
                    else if (d[i].offsetTop + d[i].offsetHeight > b.scrollTop + b.offsetHeight) d[i]._jsPlumbProxies || (d[i]._jsPlumbProxies = d[i]._jsPlumbProxies || [], a.select({
                        source: d[i]
                    }).each(function (c) {
                        a.proxyConnection(c, 0, b, h, function () {
                        ...
                        for (var j = 0; j < d[i]._jsPlumbProxies.length; j++) a.unproxyConnection(d[i]._jsPlumbProxies[j][0], d[i]._jsPlumbProxies[j][1], h);
            ...
            a.setAttribute(b, "jtk-scrollable-list", "true"), b._jsPlumbScrollHandler = h, a.on(b, "scroll", h), h(), this.destroy = function () {
                ...
                for (var c = a.getSelector(b, ".jtk-managed"), d = a.getId(b), e = 0; e < c.length; e++)
                    if (c[e]._jsPlumbProxies) {
                        for (var f = 0; f < c[e]._jsPlumbProxies.length; f++) a.unproxyConnection(c[e]._jsPlumbProxies[f][0], c[e]._jsPlumbProxies[f][1], d);
    ...
    function () {
        ...
        var a = this,
            ...
            c = function (a) {
                if (a._jsPlumb.paintStyle && a._jsPlumb.hoverPaintStyle) {
                    var b = {};
                    n.extend(b, a._jsPlumb.paintStyle), n.extend(b, a._jsPlumb.hoverPaintStyle), delete a._jsPlumb.hoverPaintStyle, b.gradient && a._jsPlumb.paintStyle.fill && delete b.gradient, a._jsPlumb.hoverPaintStyle = b
                }
            },
            d = ["tap", "dbltap", "click", "dblclick", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "contextmenu"],
            e = function (a, b, c, d) {
                        ...
                        if ("__default" !== l) {
                            ...
                            if (null != m) {
                                var n = ["anchor", "anchors", "connector", "paintStyle", "hoverPaintStyle", "endpoint", "endpoints", "connectorOverlays", "connectorStyle", "connectorHoverStyle", "endpointStyle", "endpointHoverStyle"],
                                    o = [];
                                "override" === m.mergeStrategy ? Array.prototype.push.apply(n, ["events", "overlays", "cssClass"]) : o.push("cssClass"), i = b.merge(i, m, o, n), g(f, m, l)
                            }
                        }
                    }
            ...
            i = a.jsPlumbUIComponent = function (a) {
                ...
                if (this.defaultOverlayKeys) {
                    ...
                    for (i = 0; i < g.length; i++) {
                        var j = n.convertToFullOverlaySpec(g[i]);
                        h[j[1].id] = j
                    }
                }
                var k = {
        ...
        b.extend(a.jsPlumbUIComponent, b.EventGenerator, {
            ...
            getClass: function () {
                return n.getClass(this.canvas)
            },
            hasClass: function (a) {
                return n.hasClass(this.canvas, a)
            },
            addClass: function (a) {
                n.addClass(this.canvas, a)
            },
            removeClass: function (a) {
                n.removeClass(this.canvas, a)
            },
            updateClasses: function (a, b) {
                n.updateClasses(this.canvas, a, b)
            },
            setType: function (a, b, c) {
                this.clearTypes(), this._jsPlumb.types = f(a) || [], h(this, b, c)
            },
            getType: function () {
            ...
            addType: function (a, b, c) {
                var d = f(a),
                    e = !1;
                if (null != d) {
                    for (var g = 0, i = d.length; i > g; g++) this.hasType(d[g]) || (this._jsPlumb.types.push(d[g]), e = !0);
                    e && h(this, b, c)
                }
            },
            removeType: function (a, b, c) {
                var d = f(a),
                    ...
                    g = function (a) {
                        ...
                        return -1 !== b ? (j(this, b), this._jsPlumb.types.splice(b, 1), !0) : !1
                    }.bind(this);
                if (null != d) {
                    for (var i = 0, k = d.length; k > i; i++) e = g(d[i]) || e;
                    e && h(this, b, c)
                }
            },
            clearTypes: function (a, b) {
                for (var c = this._jsPlumb.types.length, d = 0; c > d; d++) j(this, 0), this._jsPlumb.types.splice(0, 1);
                h(this, a, b)
            },
            toggleType: function (a, b, c) {
                ...
                if (null != d) {
                    for (var e = 0, g = d.length; g > e; e++) {
                        var i = this._jsPlumb.types.indexOf(d[e]); - 1 !== i ? (j(this, i), this._jsPlumb.types.splice(i, 1)) : this._jsPlumb.types.push(d[e])
                    }
                    h(this, b, c)
                }
            },
            ...
            setPaintStyle: function (a, b) {
                this._jsPlumb.paintStyle = a, this._jsPlumb.paintStyleInUse = this._jsPlumb.paintStyle, c(this), b || this.repaint()
            },
            getPaintStyle: function () {
                return this._jsPlumb.paintStyle
            },
            setHoverPaintStyle: function (a, b) {
                this._jsPlumb.hoverPaintStyle = a, c(this), b || this.repaint()
            },
            ...
            setHover: function (a, b, c) {
                if (this._jsPlumb && !this._jsPlumb.instance.currentlyDragging && !this._jsPlumb.instance.isHoverSuspended()) {
                    ...
                    null != this.canvas && (null != this._jsPlumb.instance.hoverClass && this._jsPlumb.instance[d](this.canvas, this._jsPlumb.instance.hoverClass), null != this._jsPlumb.hoverClass && this._jsPlumb.instance[d](this.canvas, this._jsPlumb.hoverClass)), null != this._jsPlumb.hoverPaintStyle && (this._jsPlumb.paintStyleInUse = a ? this._jsPlumb.hoverPaintStyle : this._jsPlumb.paintStyle, this._jsPlumb.instance.isSuspendDrawing() || (c = c || jsPlumbUtil.uuid(), this.repaint({
                        timestamp: c,
                        recalc: !1
                    }))), this.getAttachedElements && !b && e(this, a, jsPlumbUtil.uuid(), this)
                }
            }
        });
        var k = 0,
            ...
            m = a.jsPlumbInstance = function (c) {
                this.version = "2.15.6", this.Defaults = {
                    Anchor: "Bottom",
                    Anchors: [null, null],
                ...
                }, c && n.extend(this.Defaults, c), this.logEnabled = this.Defaults.LogEnabled, this._connectionTypes = {}, this._endpointTypes = {}, b.EventGenerator.apply(this);
                var e = this,
                    f = l(),
                    g = e.bind,
                    h = {},
                    ...
                    k = function (a) {
                        ...
                        var c = e.getElement(a);
                        return {
                            el: c,
                            id: b.isString(a) && null == c ? a : S(c)
                        }
                    };
                this.getInstanceIndex = function () {
                    return f
                }, this.setZoom = function (a, b) {
                    return j = a, e.fire("zoom", j), b && e.repaintEverything(), !0
                }, this.getZoom = function () {
                    return j
                };
                for (var m in this.Defaults) h[m] = this.Defaults[m];
                var o, p = [];
                this.unbindContainer = function () {
                    if (null != o && p.length > 0)
                        for (var a = 0; a < p.length; a++) e.off(o, p[a][0], p[a][1])
                    ...
                    for (var c = {
                        ...
                        var f = b.srcElement || b.target,
                            g = (f && f.parentNode ? f.parentNode._jsPlumb : null) || (f ? f._jsPlumb : null) || (f && f.parentNode && f.parentNode.parentNode ? f.parentNode.parentNode._jsPlumb : null);
                        if (g) {
                            g.fire(a, g, b);
                            var h = d ? c[d + a] || a : a;
                            e.fire(h, g.component || g, b)
                        }
                    }, g = function (a, b, c) {
                        p.push([a, c]), e.on(o, a, b, c)
                    }, h = function (a) {
                    ...
                    }, i = 0; i < d.length; i++) h(d[i]);
                    for (var j in v) {
                        var k = v[j].el;
                        k.parentNode === b && (b.removeChild(k), o.appendChild(k))
                    }
                }, this.getContainer = function () {
                    return o
                }, this.bind = function (a, b) {
                    "ready" === a && r ? b() : g.apply(e, [a, b])
                }, e.importDefaults = function (a) {
                    for (var b in a) e.Defaults[b] = a[b];
                    return a.Container && e.setContainer(a.Container), e
                }, e.restoreDefaults = function () {
                    return e.Defaults = n.extend({}, h), e
                };
                var q = null,
                    r = !1,
                    s = [],
                    ...
                    F = function (a, b) {
                        o ? o.appendChild(a) : b ? this.getElement(b).appendChild(a) : this.appendToRoot(a)
                    }.bind(this),
                    G = function (a, b, c, d) {
                        var f = {
                            c: [],
                        ...
                        if (!A && (a = e.getElement(a), null != a)) {
                            var g = S(a),
                                h = a.querySelectorAll(".jtk-managed");
                            null == c && (c = jsPlumbUtil.uuid());
                            for (var i = (na({
                                elId: g,
                                offset: b,
                                recalc: !1,
                                ...
                                elId: h[i].getAttribute("id"),
                                recalc: !0,
                                timestamp: c
                            });
                            var j = e.router.redraw(g, b, c, null, d);
                            if (Array.prototype.push.apply(f.c, j.c), Array.prototype.push.apply(f.e, j.e), h)
                                for (var k = 0; k < h.length; k++) j = e.router.redraw(h[k].getAttribute("id"), null, c, null, d, !0), Array.prototype.push.apply(f.c, j.c), Array.prototype.push.apply(f.e, j.e)
                        }
                        return f
                    },
                    H = function (a) {
                    ...
                    K = function (a, c) {
                        ...
                        return i("source", 0, this.sourceEndpointDefinitions, d.type || "default") !== !1 && i("target", 1, this.targetEndpointDefinitions, d.type || "default") !== !1 ? (d.sourceEndpoint && d.targetEndpoint && (I(d.sourceEndpoint, d.targetEndpoint) || (d = null)), d) : void 0
                    }.bind(e),
                    L = function (a) {
                        var b = e.Defaults.ConnectionType || e.getDefaultConnectionType();
                        a._jsPlumb = e, a.newConnection = L, a.newEndpoint = N, a.endpointsByUUID = u, a.endpointsByElement = t, a.finaliseConnection = M, a.id = "con_" + E();
                        var c = new b(a);
                        return c.isDetachable() && (c.endpoints[0].initDraggable("_jsPlumbSource"), c.endpoints[1].initDraggable("_jsPlumbTarget")), c
                    },
                    M = e.finaliseConnection = function (a, b, c, d) {
                        if (b = b || {}, a.suspendedEndpoint || s.push(a), a.pending = null, a.endpoints[0].isTemporarySource = !1, d !== !1 && e.router.newConnection(a), G(a.source), !b.doNotFireConnectionEvent && b.fireEvent !== !1) {
                            var f = {
                                connection: a,
                                source: a.source,
                                target: a.target,
                    ...
                    N = function (a, b) {
                        var c = e.Defaults.EndpointType || n.Endpoint,
                            d = n.extend({}, a);
                        d._jsPlumb = e, d.newConnection = L, d.newEndpoint = N, d.endpointsByUUID = u, d.endpointsByElement = t, d.fireDetachEvent = V, d.elementId = b || S(d.source);
                        var f = new c(d);
                        return f.id = "ep_" + E(), ma(d.elementId, d.source), n.headless || e.getDragManager().endpointAdded(d.source, b), f
                    },
                    O = function (a, b, c) {
                        var d = t[a];
                        if (d && d.length)
                    ...
                    S = function (a, c, d) {
                        ...
                        if (null == a) return null;
                        var g = e.getAttribute(a, "id");
                        return g && "undefined" !== g || (2 === arguments.length && void 0 !== arguments[1] ? g = c : (1 === arguments.length || 3 === arguments.length && !arguments[2]) && (g = "jsPlumb_" + f + "_" + E()), d || e.setAttribute(a, "id", g)), g
                    };
                this.setConnectionBeingDragged = function (a) {
                    ...
                    d = d || {};
                    var f = n.extend({}, d);
                    n.extend(f, c), f.endpoint = f.endpoint || e.Defaults.Endpoint, f.paintStyle = f.paintStyle || e.Defaults.EndpointStyle;
                    for (var g = [], h = b.isArray(a) || null != a.length && !b.isString(a) ? a : [a], i = 0, j = h.length; j > i; i++) {
                        f.source = e.getElement(h[i]), ka(f.source);
                        var k = S(f.source),
                            l = N(f, k),
                            m = ma(k, f.source, null, !A).info.o;
                        b.addToList(t, k, l), A || l.paint({
                            anchorLoc: l.anchor.compute({
                                xy: [m.left, m.top],
                                wh: z[k],
                                element: l,
                                timestamp: B,
                                rotation: this.getRotation(k)
                            }),
                            timestamp: B
                        }), g.push(l)
                    }
                    ...
                    for (var f = [], g = 0, h = c.length; h > g; g++) {
                        var i = e.addEndpoint(a, c[g], d);
                        b.isArray(i) ? Array.prototype.push.apply(f, i) : f.push(i)
                    }
                    return f
                }, this.animate = function (a, c, d) {
                    if (!this.animationSupported) return !1;
                    d = d || {};
                    var f = e.getElement(a),
                        g = S(f),
                        h = n.animEvents.step,
                        i = n.animEvents.complete;
                    ...
                    var d = e.getListener(a),
                        f = !0;
                    if (d && d.length > 0) {
                        var g = Array.prototype.slice.call(arguments, 1);
                        try {
                            for (var h = 0, i = d.length; i > h; h++) f = f && d[h].apply(d[h], g)
                        } catch (j) {
                            b.log(e, "cannot check condition [" + a + "]" + j)
                        }
                    }
                    return f
                ...
                var T = [{
                    ...
                    U = function (a, b, c, d) {
                        ...
                        if (b.constructor === n.Endpoint) e = b, e.addConnection(a),
                            b = e.element;
                        else if (f = S(b), g = this[h.epDefs][f], f === a[h.elId]) e = null;
                        else if (g)
                            for (var l in g) {
                        ...
                        return null != e && (j.detachFromConnection(a), a.endpoints[c] = e, a[h.el] = e.element, a[h.elId] = e.elementId, k[0 === c ? "newSourceId" : "newTargetId"] = e.elementId, W(k), d || a.repaint()), k.element = b, k
                    }.bind(this);
                this.setSource = function (a, b, c) {
                    var d = U(a, b, 0, c);
                    this.router.sourceOrTargetChanged(d.originalSourceId, d.newSourceId, a, d.el, 0)
                }, this.setTarget = function (a, b, c) {
                    var d = U(a, b, 1, c);
                    this.router.sourceOrTargetChanged(d.originalTargetId, d.newTargetId, a, d.el, 1)
                }, this.deleteEndpoint = function (a, b, c) {
                    var d = "string" == typeof a ? u[a] : a;
                    return d && e.deleteObject({
                        endpoint: d,
                        dontUpdateHover: b,
                    ...
                    for (var b in t) {
                        var c = t[b];
                        if (c && c.length)
                            for (var d = 0, f = c.length; f > d; d++) e.deleteEndpoint(c[d], !0)
                    }
                    t = {}, v = {}, u = {}, w = {}, x = {}, e.router.reset();
                    var g = e.getDragManager();
                    return g && g.reset(), a || e.setSuspendDrawing(!1), e
                };
                var V = function (a, b, c) {
                    var d = e.Defaults.ConnectionType || e.getDefaultConnectionType(),
                        f = a.constructor === d,
                        g = f ? {
                            connection: a,
                            source: a.source,
                    ...
                    b && e.fire("connectionDetached", g, c), e.fire("internal.connectionDetached", g, c), e.router.connectionDetached(g)
                },
                    W = e.fireMoveEvent = function (a, b) {
                        e.fire("connectionMoved", a, b)
                    };
                this.unregisterEndpoint = function (a) {
                    a._jsPlumb.uuid && (u[a._jsPlumb.uuid] = null), e.router.deleteEndpoint(a);
                    for (var b in t) {
                        var c = t[b];
                        if (c) {
                        ...
                        t[b].length < 1 && delete t[b]
                    }
                };
                var X = "isDetachAllowed",
                    Y = "beforeDetach",
                    Z = "checkCondition";
                this.deleteConnection = function (a, c) {
                    return null != a && (c = c || {}, c.force || b.functionChain(!0, !1, [
                        ...
                        [a, X, [a]],
                        [e, Z, [Y, a]]
                    ])) ? (a.setHover(!1), V(a, !a.pending && c.fireEvent !== !1, c.originalEvent), a.endpoints[0].detachFromConnection(a), a.endpoints[1].detachFromConnection(a), b.removeWithFunction(s, function (b) {
                        return a.id === b.id
                    ...
                    return e.batch(function () {
                        for (var d = 0; b > d; d++) c += e.deleteConnection(s[0], a) ? 1 : 0
                    }), c
                }, this.deleteConnectionsForElement = function (a, b) {
                    b = b || {}, a = e.getElement(a);
                    var c = S(a),
                        d = t[c];
                    if (d && d.length)
                        for (var f = 0, g = d.length; g > f; f++) d[f].deleteEveryConnection(b);
                    return e
                    ...
                    var c = {
                        ...
                        g = function (b) {
                            if (null != b && null == c.endpoints[b.id] && (a.dontUpdateHover || null == b._jsPlumb || b.setHover(!1), c.endpoints[b.id] = b, c.endpointCount++, d))
                                for (var e = 0; e < b.connections.length; e++) {
                                    var g = b.connections[e];
                                    f(g)
                                }
                        };
                    ...
                    for (var h in c.connections) {
                        ...
                        if (i._jsPlumb) {
                            b.removeWithFunction(s, function (a) {
                                return i.id === a.id
                            }), V(i, a.fireEvent === !1 ? !1 : !i.pending, a.originalEvent);
                    ...
                    for (var k in c.endpoints) {
                        var l = c.endpoints[k];
                        l._jsPlumb && (e.unregisterEndpoint(l), l.cleanup(!0), l.destroy(!0))
                    }
                    return c
                };
                    ...
                    ca = function (a, b) {
                        ...
                        if (a)
                            if ("string" == typeof a) {
                                ...
                                for (var d = 0, e = a.length; e > d; d++) c.push(k(a[d]).id);
                            else c.push(k(a).id);
                        return c
                    },
                    da = function (a, b, c) {
                ...
                this.getConnections = function (a, b) {
                    ...
                    for (var c = a.scope || e.getDefaultScope(), d = ca(c, !0), f = ca(a.source), g = ca(a.target), h = !b && d.length > 1 ? {} : [], i = function (a, c) {
                        if (!b && d.length > 1) {
                            var e = h[a];
                            null == e && (e = h[a] = []), e.push(c)
                        } else h.push(c)
                    }, j = 0, k = s.length; k > j; j++) {
                        var l = s[j],
                        ...
                        da(d, l.scope) && da(f, m) && da(g, n) && i(l.scope, l)
                    }
                    return h
                };
                var ea = function (a, b) {
                    ...
                    ga = function (a, b) {
                        ...
                        for (c = 0, d = f.length; d > c; c++) e[f[c]] = aa(a, f[c], b);
                        for (c = 0, d = g.length; d > c; c++) e[g[c]] = ba(a, g[c]);
                        return e
                    },
                    ha = function (a) {
                        var b = ga(a, ha);
                        return n.extend(b, {
                            setDetachable: aa(a, "setDetachable", ha),
                            setReattach: aa(a, "setReattach", ha),
                            setConnector: aa(a, "setConnector", ha),
                            "delete": function () {
                                for (var b = 0, c = a.length; c > b; b++) e.deleteConnection(a[b])
                            },
                            isDetachable: ba(a, "isDetachable"),
                            isReattach: ba(a, "isReattach")
                        })
                    },
                    ia = function (a) {
                        var b = ga(a, ia);
                        return n.extend(b, {
                            setEnabled: aa(a, "setEnabled", ia),
                            setAnchor: aa(a, "setAnchor", ia),
                            isEnabled: ba(a, "isEnabled"),
                            deleteEveryConnection: function () {
                                for (var b = 0, c = a.length; c > b; b++) a[b].deleteEveryConnection()
                            },
                            "delete": function () {
                                for (var b = 0, c = a.length; c > b; b++) e.deleteEndpoint(a[b])
                            }
                        })
                    };
                this.select = function (a) {
                    return a = a || {}, a.scope = a.scope || "*", ha(a.connections || e.getConnections(a, !0))
                    ...
                    for (var h in t) {
                        var i = da(c, h, !0),
                            ...
                            l = da(e, h, !0),
                            m = "*" !== e;
                        if (i || j || l) a: for (var n = 0, o = t[h].length; o > n; n++) {
                            var p = t[h][n];
                            if (da(f, p.scope, !0)) {
                    ...
                    return C
                }, this.getEndpoint = H, this.getEndpoints = function (a) {
                    return t[k(a).id] || []
                }, this.getDefaultEndpointType = function () {
                    return n.Endpoint
                }, this.getDefaultConnectionType = function () {
                    return n.Connection
                }, this.getId = S, this.draw = G, this.info = k, this.appendElement = F;
                var ja = !1;
                ...
                var ka = function (a) {
                    if (!o && a) {
                        ...
                        b.offsetParent && e.setContainer(b.offsetParent)
                    }
                },
                    la = function () {
                        e.Defaults.Container && e.setContainer(e.Defaults.Container)
                    },
                    ma = e.manage = function (a, b, c, d) {
                        return v[a] ? d && (v[a].info = na({
                            elId: a,
                            timestamp: B,
                            recalc: !0
                        })) : (v[a] = {
                            ...
                            elId: a,
                            timestamp: B
                        }), e.addClass(b, "jtk-managed"), c || e.fire("manageElement", {
                            id: a,
                            info: v[a].info,
                            el: b
                        })), v[a]
                    };
                this.unmanage = function (a) {
                    if (v[a]) {
                        var b = v[a].el;
                        e.removeClass(b, "jtk-managed"), delete v[a], e.fire("unmanageElement", {
                            id: a,
                            el: b
                        })
                    }
                }, this.rotate = function (a, b, c) {
                    return v[a] && (v[a].rotation = b, v[a].el.style.transform = "rotate(" + b + "deg)", v[a].el.style.transformOrigin = "center center", c !== !0) ? this.revalidate(a) : {
                        c: [],
                        e: []
                    }
                }, this.getRotation = function (a) {
                    return v[a] ? v[a].rotation || 0 : 0
                };
                var na = function (a) {
                    var b, c = a.timestamp,
                        d = a.recalc,
                        f = a.offset,
                        g = a.elId;
                    return A && !c && (c = B), !d && c && c === x[g] ? {
                        o: a.offset || w[g],
                        s: z[g]
                    } : (d || !f && null == w[g] ? (b = v[g] ? v[g].el : null, null != b && (z[g] = e.getSize(b), w[g] = e.getOffset(b), x[g] = c)) : (w[g] = f || w[g], null == z[g] && (b = v[g].el, null != b && (z[g] = e.getSize(b))), x[g] = c), w[g] && !w[g].right && (w[g].right = w[g].left + z[g][0], w[g].bottom = w[g].top + z[g][1], w[g].width = z[g][0], w[g].height = z[g][1], w[g].centerx = w[g].left + w[g].width / 2, w[g].centery = w[g].top + w[g].height / 2), {
                        o: w[g],
                        s: z[g]
                    })
                };
                this.updateOffset = na, this.init = function () {
                    r || (la(), e.router = new a.jsPlumb.DefaultRouter(e), e.anchorManager = e.router.anchorManager, r = !0, e.fire("ready", e))
                }.bind(this), this.log = q, this.jsPlumbUIComponent = i, this.makeAnchor = function () {
                    var c, d = function (b, c) {
                        if (a.jsPlumb.Anchors[b]) return new a.jsPlumb.Anchors[b](c);
                        if (!e.Defaults.DoNotThrowErrors) throw {
                    ...
                    var f = arguments[0],
                        g = arguments[1],
                        h = (arguments[2], null);
                    if (f.compute && f.getOrientation) return f;
                    if ("string" == typeof f) h = d(arguments[0], {
                        elementId: g,
                        jsPlumbInstance: e
                    });
                    else if (b.isArray(f))
                        if (b.isArray(f[0]) || b.isString(f[0])) 2 === f.length && b.isObject(f[1]) ? b.isString(f[0]) ? (c = a.jsPlumb.extend({
                            elementId: g,
                            jsPlumbInstance: e
                        }, f[1]), h = d(f[0], c)) : (c = a.jsPlumb.extend({
                            elementId: g,
                            jsPlumbInstance: e,
                            anchors: f[0]
                        }, f[1]), h = new a.jsPlumb.DynamicAnchor(c)) : h = new n.DynamicAnchor({
                            anchors: f,
                            selector: null,
                            elementId: g,
                            jsPlumbInstance: e
                            ...
                            var i = {
                                x: f[0],
                                y: f[1],
                                orientation: f.length >= 4 ? [f[2], f[3]] : [0, 0],
                                offsets: f.length >= 6 ? [f[4], f[5]] : [0, 0],
                                elementId: g,
                                jsPlumbInstance: e,
                                cssClass: 7 === f.length ? f[6] : null
                            };
                            h = new a.jsPlumb.Anchor(i), h.clone = function () {
                                return new a.jsPlumb.Anchor(i)
                            }
                        } return h.id || (h.id = "anchor_" + E()), h
                }, this.makeAnchors = function (c, d, f) {
                    for (var g = [], h = 0, i = c.length; i > h; h++) "string" == typeof c[h] ? g.push(a.jsPlumb.Anchors[c[h]]({
                        elementId: d,
                        jsPlumbInstance: f
                    })) : b.isArray(c[h]) && g.push(e.makeAnchor(c[h], d, f));
                    return g
                        ...
                        var j = new i(d),
                            k = d._jsPlumb.EndpointDropHandler({
                                ...
                                isDropAllowed: function () {
                                    return j.isDropAllowed.apply(j, arguments)
                                },
                                isRedrop: function (a) {
                                    return null != a.suspendedElement && null != a.suspendedEndpoint && a.suspendedEndpoint.element === c.el
                                },
                                getEndpoint: function (b) {
                                    var f = c.def.endpoint;
                                    if (null == f || null == f._jsPlumb) {
                                        var g = e.deriveEndpointAndAnchorSpec(b.getType().join(" "), !0),
                                        ...
                                        })), f = e.addEndpoint(c.el, h), f._mtNew = !0
                                    }
                                    if (d.uniqueEndpoint && (c.def.endpoint = f), f.setDeleteOnEmpty(!0), b.isDetachable() && f.initDraggable(), null != f.anchor.positionFinder) {
                                        var i = e.getUIPosition(arguments, e.getZoom()),
                                            j = e.getOffset(c.el),
                                            k = e.getSize(c.el),
                                            l = null == i ? [0, 0] : f.anchor.positionFinder(i, j, k, f.anchor.constructorParams);
                                        f.anchor.x = l[0], f.anchor.y = l[1]
                                    }
                                    return f
                                },
                                maybeCleanup: function (a) {
                                    a._mtNew && 0 === a.connections.length ? e.deleteObject({
                                        endpoint: a
                                    }) : delete a._mtNew
                                }
                            }),
                            l = a.jsPlumb.dragEvents.drop;
                        return f.scope = f.scope || d.scope || e.Defaults.Scope, f[l] = b.wrap(f[l], k, !0), f.rank = d.rank || 0, h && (f[a.jsPlumb.dragEvents.over] = function () {
                            return !0
                        }), d.allowLoopback === !1 && (f.canDrop = function (a) {
                            var b = a.getDragElement()._jsPlumbRelatedElement;
                            return b !== c.el
                        }), e.initDroppable(c.el, f, "internal"), k
                    };
                this.makeTarget = function (b, c, d) {
                    var f = a.jsPlumb.extend({
                        _jsPlumb: this
                    }, d);
                    a.jsPlumb.extend(f, c);
                    for (var g = f.maxConnections || -1, h = function (b) {
                        var c = k(b),
                            d = c.id,
                            h = a.jsPlumb.extend({}, f.dropOptions || {}),
                            i = f.connectionType || "default";
                        this.targetEndpointDefinitions[d] = this.targetEndpointDefinitions[d] || {}, ka(d), c.el._isJsPlumbGroup && null == h.rank && (h.rank = -1);
                        var j = {
                            def: a.jsPlumb.extend({}, f),
                            uniqueEndpoint: f.uniqueEndpoint,
                            maxConnections: g,
                            enabled: !0
                        };
                        f.createEndpoint && (j.uniqueEndpoint = !0, j.endpoint = e.addEndpoint(b, j.def), j.endpoint.setDeleteOnEmpty(!1)), c.def = j, this.targetEndpointDefinitions[d][i] = j, pa(c, f, h, f.isSource === !0, !0), c.el._katavorioDrop[c.el._katavorioDrop.length - 1].targetDef = j
                    }.bind(this), i = b.length && b.constructor !== String ? b : [b], j = 0, l = i.length; l > j; j++) h(i[j]);
                    return this
                }, this.unmakeTarget = function (a, b) {
                    var c = k(a);
                    return e.destroyDroppable(c.el, "internal"), b || delete this.targetEndpointDefinitions[c.id], this
                    ...
                    var h = g.connectionType || "default",
                        i = e.deriveEndpointAndAnchorSpec(h);
                    g.endpoint = g.endpoint || i.endpoints[0], g.anchor = g.anchor || i.anchors[0];
                    for (var l = g.maxConnections || -1, m = g.onMaxConnections, n = function (d) {
                        var f = d.id,
                            i = this.getElement(d.el);
                        this.sourceEndpointDefinitions[f] = this.sourceEndpointDefinitions[f] || {}, ka(f);
                        var k = {
                        ...
                        g.createEndpoint && (k.uniqueEndpoint = !0, k.endpoint = e.addEndpoint(c, k.def), k.endpoint.setDeleteOnEmpty(!1)), this.sourceEndpointDefinitions[f][h] = k, d.def = k;
                        ...
                        var u = function (c) {
                            if (3 !== c.which && 2 !== c.button) {
                                f = this.getId(this.getElement(d.el));
                                var k = this.sourceEndpointDefinitions[f][h];
                                if (k.enabled) {
                                    if (g.filter) {
                                        var n = b.isString(g.filter) ? oa(c, d.el, g.filter, this, g.filterExclude) : g.filter(c, d.el);
                                        if (n === !1) return
                                    }
                                    var o = this.select({
                                        source: f
                                    }).length;
                                    if (k.maxConnections >= 0 && o >= k.maxConnections) return m && m({
                                        element: d.el,
                                        maxConnections: l
                                    }, c), !1;
                                    var q = a.jsPlumb.getPositionOnElement(c, i, j),
                                        r = {};
                                    a.jsPlumb.extend(r, k.def), r.isTemporarySource = !0, r.anchor = [q[0], q[1], 0, 0], r.dragOptions = p, k.def.scope && (r.scope = k.def.scope), s = this.addEndpoint(f, r), t = !0, s.setDeleteOnEmpty(!0), k.uniqueEndpoint && (k.endpoint ? s.finalEndpoint = k.endpoint : (k.endpoint = s, s.setDeleteOnEmpty(!1)));
                                    var u = function () {
                                        e.off(s.canvas, "mouseup", u), e.off(d.el, "mouseup", u), t && (t = !1, e.deleteEndpoint(s))
                                    };
                                    e.on(s.canvas, "mouseup", u), e.on(d.el, "mouseup", u);
                                    var v = {};
                                    if (k.def.extract)
                                        for (var w in k.def.extract) {
                                            var x = (c.srcElement || c.target).getAttribute(w);
                                            x && (v[k.def.extract[w]] = x)
                                        }
                                    e.trigger(s.canvas, "mousedown", c, v), b.consume(c)
                                }
                            }
                        }.bind(this);
                        this.on(d.el, "mousedown", u), k.trigger = u, g.filter && (b.isString(g.filter) || b.isFunction(g.filter)) && e.setDragFilter(d.el, g.filter);
                        var v = a.jsPlumb.extend({}, g.dropOptions || {});
                        pa(d, g, v, !0, g.isTarget === !0)
                    }.bind(this), o = c.length && c.constructor !== String ? c : [c], p = 0, q = o.length; q > p; p++) n(k(o[p]));
                    return this
                }, this.unmakeSource = function (a, b, c) {
                    var d = k(a);
                    e.destroyDroppable(d.el, "internal");
                    var f = this.sourceEndpointDefinitions[d.id];
                    if (f)
                        for (var g in f)
                            if (null == b || b === g) {
                                var h = f[g].trigger;
                                h && e.off(d.el, "mousedown", h), c || delete this.sourceEndpointDefinitions[d.id][g]
                            } return this
                }, this.unmakeEverySource = function () {
                    for (var a in this.sourceEndpointDefinitions) e.unmakeSource(a, null, !0);
                ...
                this.getScope = function (a, b) {
                    return qa(a, ["sourceEndpointDefinitions", "targetEndpointDefinitions"])
                }, this.getSourceScope = function (a) {
                    return qa(a, "sourceEndpointDefinitions")
                }, this.getTargetScope = function (a) {
                    return qa(a, "targetEndpointDefinitions")
                }, this.setScope = function (a, b, c) {
                    this.setSourceScope(a, b, c), this.setTargetScope(a, b, c)
                }, this.setSourceScope = function (a, b, c) {
                    ra(a, b, "sourceEndpointDefinitions", c), this.setDragScope(a, b)
                }, this.setTargetScope = function (a, b, c) {
                    ra(a, b, "targetEndpointDefinitions", c), this.setDropScope(a, b)
                }, this.unmakeEveryTarget = function () {
                    for (var a in this.targetEndpointDefinitions) e.unmakeTarget(a, !0);
                    return this.targetEndpointDefinitions = {}, this
                };
                var sa = function (a, c, d, f, g) {
                    var h, i, j, l = "source" === a ? this.sourceEndpointDefinitions : this.targetEndpointDefinitions;
                    if (g = g || "default", c.length && !b.isString(c)) {
                        h = [];
                        for (var m = 0, n = c.length; n > m; m++) i = k(c[m]), l[i.id] && l[i.id][g] && (h[m] = l[i.id][g].enabled, j = f ? !h[m] : d, l[i.id][g].enabled = j, e[j ? "removeClass" : "addClass"](i.el, "jtk-" + a + "-disabled"))
                    } else {
                        i = k(c);
                        var o = i.id;
                        l[o] && l[o][g] && (h = l[o][g].enabled, j = f ? !h : d, l[o][g].enabled = j, e[j ? "removeClass" : "addClass"](i.el, "jtk-" + a + "-disabled"))
                    }
                    return h
                }.bind(this),
                    ta = function (a, c) {
                        if (null != a) {
                            if (b.isString(a) || !a.length) return c.apply(this, [a]);
                            if (a.length) return c.apply(this, [a[0]])
                        }
                    }.bind(this);
                this.toggleSourceEnabled = function (a, b) {
                    return sa("source", a, null, !0, b), this.isSourceEnabled(a, b)
                }, this.setSourceEnabled = function (a, b, c) {
                    return sa("source", a, b, null, c)
                }, this.isSource = function (a, b) {
                    return b = b || "default", ta(a, function (a) {
                        var c = this.sourceEndpointDefinitions[k(a).id];
                    ...
                    return sa("target", a, null, !0, b), this.isTargetEnabled(a, b)
                }, this.isTarget = function (a, b) {
                    return b = b || "default", ta(a, function (a) {
                        var c = this.targetEndpointDefinitions[k(a).id];
                        return null != c && null != c[b]
                    }.bind(this))
                ...
                this.repaint = function (a, b, c) {
                    ...
                    var f = e.getDragManager();
                    return f && f.updateOffsets(d), G(a, null, b)
                }, this.repaintEverything = function () {
                    var a, b = jsPlumbUtil.uuid();
                    for (a in t) e.updateOffset({
                        elId: a,
                        recalc: !0,
                        timestamp: b
                    });
                    for (a in t) G(a, null, b);
                    return this
                    ...
                    var d = function (a) {
                        var f, g, h = k(a),
                            i = t[h.id];
                        if (i)
                            for (c.push(h), f = 0, g = i.length; g > f; f++) e.deleteEndpoint(i[f], !1);
                        if (delete t[h.id], b && h.el && 3 !== h.el.nodeType && 8 !== h.el.nodeType)
                            for (f = 0, g = h.el.childNodes.length; g > f; f++) d(h.el.childNodes[f])
                    };
                    return d(a), this
                };
                var va = function (a, b) {
                    e.removeAllEndpoints(a.id, !0, b);
                    for (var c = e.getDragManager(), d = function (a) {
                        c && c.elementRemoved(a.id), e.router.elementRemoved(a.id), e.isSource(a.el) && e.unmakeSource(a.el), e.isTarget(a.el) && e.unmakeTarget(a.el), e.destroyDraggable(a.el), e.destroyDroppable(a.el), delete e.floatingConnections[a.id], delete v[a.id], delete w[a.id], a.el && (e.removeElement(a.el), a.el._jsPlumb = null)
                    }, f = 1; f < b.length; f++) d(b[f]);
                    d(a)
                };
                this.remove = function (a, b) {
                    var c = k(a),
                        d = [];
                    return c.text && c.el.parentNode ? c.el.parentNode.removeChild(c.el) : c.id && e.batch(function () {
                        va(c, d)
                    }, b === !0), e
                    ...
                    e.silently(function () {
                        ja = !1, e.removeAllGroups(), e.removeGroupManager(), e.deleteEveryEndpoint(), a || e.unbind(), this.targetEndpointDefinitions = {}, this.sourceEndpointDefinitions = {}, s.length = 0, this.doReset && this.doReset()
                    }.bind(this))
                }, this.destroy = function () {
                    this.reset(), o = null, p = null
                };
                var wa = function (a) {
                    a.canvas && a.canvas.parentNode && a.canvas.parentNode.removeChild(a.canvas), a.cleanup(), a.destroy()
                };
                this.clear = function () {
                    e.select().each(wa), e.selectEndpoints().each(wa), t = {}, u = {}
                }, this.setDefaultScope = function (a) {
                    return C = a, e
                }, this.deriveEndpointAndAnchorSpec = function (a, b) {
                    for (var c = ((b ? "" : "default ") + a).split(/[\s]/), d = null, f = null, g = null, h = null, i = 0; i < c.length; i++) {
                        var j = e.getType(c[i], "connection");
                        j && (j.endpoints && (d = j.endpoints), j.endpoint && (f = j.endpoint), j.anchors && (h = j.anchors), j.anchor && (g = j.anchor))
                    }
                    return {
                        endpoints: d ? d : [f, f],
                        anchors: h ? h : [g, g]
                    ...
                    c = "" + c, d ? a = this.getElement(c) : (a = this.getElement(e), this.setAttribute(a, "id", c)), t[c] = t[e] || [];
                    for (var h = 0, i = t[c].length; i > h; h++) t[c][h].setElementId(c), t[c][h].setReferenceElement(a);
                    delete t[e], this.sourceEndpointDefinitions[c] = this.sourceEndpointDefinitions[e], delete this.sourceEndpointDefinitions[e], this.targetEndpointDefinitions[c] = this.targetEndpointDefinitions[e], delete this.targetEndpointDefinitions[e], this.router.changeId(e, c);
                    var j = this.getDragManager();
                    j && j.changeId(e, c), v[c] = v[e], delete v[e];
                    var k = function (b, d, e) {
                        for (var f = 0, g = b.length; g > f; f++) b[f].endpoints[d].setElementId(c), b[f].endpoints[d].setReferenceElement(a), b[f][e + "Id"] = c, b[f][e] = a
                    };
                ...
                }, this.doWhileSuspended = this.batch, this.getCachedData = R, this.show = function (a, b) {
                    return P(a, "block", b), e
                }, this.toggleVisible = Q, this.addListener = this.bind;
                var xa = [];
                this.registerFloatingConnection = function (a, c, d) {
                    xa[a.id] = c, b.addToList(t, a.id, d)
                }, this.getFloatingConnectionFor = function (a) {
                    return xa[a]
                }, this.listManager = new a.jsPlumbListManager(this, this.Defaults.ListStyle)
            };
        b.extend(a.jsPlumbInstance, b.EventGenerator, {
            ...
            proxyConnection: function (a, b, c, d, e, f) {
                var g, h = a.endpoints[b].elementId,
                    i = a.endpoints[b];
                a.proxies = a.proxies || [], g = a.proxies[b] ? a.proxies[b].ep : this.addEndpoint(c, {
                    ...
                    ep: g,
                    originalEp: i
                }, 0 === b ? this.router.sourceOrTargetChanged(h, d, a, c, 0) : this.router.sourceOrTargetChanged(h, d, a, c, 1), i.detachFromConnection(a, null, !0), g.connections = [a], a.endpoints[b] = g, i.setVisible(!1), a.setVisible(!0), this.revalidate(c)
            },
            unproxyConnection: function (a, b, c) {
                if (null != a._jsPlumb && null != a.proxies && null != a.proxies[b]) {
                    ...
                    a.endpoints[b] = a.proxies[b].originalEp, 0 === b ? this.router.sourceOrTargetChanged(c, e, a, d, 0) : this.router.sourceOrTargetChanged(c, e, a, d, 1), a.proxies[b].ep.detachFromConnection(a, null), a.proxies[b].originalEp.addConnection(a), a.isVisible() && a.proxies[b].originalEp.setVisible(!0), delete a.proxies[b]
                }
            }
        });
        var n = new m;
        a.jsPlumb = n, n.getInstance = function (a, b) {
            var c = new m(a);
            if (b)
            ...
            if (null != a)
                if ("string" == typeof a) b(n.getElement(a));
                else if (null != a.length)
                    for (var c = 0; c < a.length; c++) b(n.getElement(a[c]));
                else b(a)
        }, "undefined" != typeof exports && (exports.jsPlumb = n)
    }.call("undefined" != typeof window ? window : this),
    function () {
        "use strict";
        var a = this,
        ...
        b.OverlayCapableJsPlumbUIComponent = function (b) {
            ...
            if (b.overlays) {
                ...
                for (c in b.overlays) {
                    ...
                    if (e) e.updateFrom(b.overlays[c][1]), d[b.overlays[c][1].id] = !0, e.reattach(a._jsPlumb.instance, a);
                    else {
            ...
            setHover: function (a, b) {
                if (this._jsPlumb && !this._jsPlumb.instance.isConnectionBeingDragged())
                    for (var c in this._jsPlumb.overlays) this._jsPlumb.overlays[c][a ? "addClass" : "removeClass"](this._jsPlumb.instance.hoverClass)
            },
    ...
    function () {
        ...
        b.Endpoint = function (a) {
            var i = a._jsPlumb,
                j = a.newConnection,
                k = a.newEndpoint;
            this.idPrefix = "_jsplumb_e_", this.defaultLabelLocation = [.5, .5],
                this.defaultOverlayKeys = ["Overlays", "EndpointOverlays"], b.OverlayCapableJsPlumbUIComponent.apply(this, arguments), this.appendToDefaultType({
            ...
            this.bind("mouseover", function () {
                ...
                o(!1)
            }), a._transient || this._jsPlumb.instance.router.addEndpoint(this, this.elementId), this.prepareEndpoint = function (d, e) {
                ...
                return c.removeWithFunction(a.endpointsByElement[this.elementId], function (a) {
                    return a.id === this.id
                }.bind(this)), this.element = b.getElement(d), this.elementId = i.getId(this.element), i.router.rehomeEndpoint(this, f, this.element), i.dragManager.endpointAdded(this.element), c.addToList(a.endpointsByElement, e, this), this
                        ...
                        if (null == f) {
                            ...
                            if (c && this.anchor.isDynamic && this.connections.length > 0) {
                                var l = h(this, a.elementWithPrecedence),
                                    ...
                                    p = o.o,
                                    q = o.s;
                                k.index = 0 === m ? 1 : 0, k.connection = l, k.txy = [p.left, p.top], k.twh = q, k.tElement = l.endpoints[m], k.tRotation = i.getRotation(n)
                            } else this.connections.length > 0 && (k.connection = this.connections[0]);
                            k.rotation = i.getRotation(this.elementId), f = this.anchor.compute(k)
                        }
                    ...
                    var g, h = {
                        ...
                        y = function (c) {
                            ...
                            if (null == m) this.setHover(!1, !1), m = j({
                                ...
                                scope: a.scope,
                                data: l
                            }), m.pending = !0, m.addClass(i.draggingClass), this._jsPlumb.floatingEndpoint.addClass(i.draggingClass), this._jsPlumb.floatingEndpoint.anchor = x, i.fire("connectionDrag", m), i.router.newConnection(m);
                            else {
                                n = !0, m.setHover(!1);
                    ...
                    if (!j || null != i.suspendedEndpoint._jsPlumb) {
                        ...
                        if (null != k) {
                            ...
                            if (m && k.fire("maxConnections", {
                                ...
                                var n = !0;
                                0 === l ? (i.floatingElement = i.source, i.floatingId = i.sourceId, i.floatingEndpoint = i.endpoints[0], i.floatingIndex = 0, i.source = a.element, i.sourceId = d.getId(a.element)) : (i.floatingElement = i.target, i.floatingId = i.targetId, i.floatingEndpoint = i.endpoints[1], i.floatingIndex = 1, i.target = a.element, i.targetId = d.getId(a.element)), j && i.suspendedEndpoint.id !== k.id && (i.isDetachAllowed(i) && i.endpoints[l].isDetachAllowed(i) && i.suspendedEndpoint.isDetachAllowed(i) && d.checkCondition("beforeDetach", i) || (n = !1));
                                var o = function (b) {
                                    ...
                                    if (1 === l ? d.router.sourceOrTargetChanged(i.floatingId, i.targetId, i, i.target, 1) : d.router.sourceOrTargetChanged(i.floatingId, i.sourceId, i, i.source, 0), i.endpoints[0].finalEndpoint) {
                                        var m = i.endpoints[0];
                                    ...
                                    p = function () {
                                        i.suspendedEndpoint && (i.endpoints[l] = i.suspendedEndpoint, i.setHover(!1), i._forceDetach = !0, 0 === l ? (i.source = i.suspendedEndpoint.element, i.sourceId = i.suspendedEndpoint.elementId) : (i.target = i.suspendedEndpoint.element, i.targetId = i.suspendedEndpoint.elementId), i.suspendedEndpoint.addConnection(i), 1 === l ? d.router.sourceOrTargetChanged(i.floatingId, i.targetId, i, i.target, 1) : d.router.sourceOrTargetChanged(i.floatingId, i.sourceId, i, i.source, 0), d.repaint(i.sourceId), i._forceDetach = !1)
                                    };
            ...
            if (!e.isSuspendDrawing()) {
                var k = e.getCachedData(this.sourceId),
                    ...
                    r = this.endpoints[0].anchor.compute({
                        ...
                        timestamp: q,
                        rotation: e.getRotation(this.endpoints[0].elementId)
                    });
                this.endpoints[0].paint({
                    ...
                    timestamp: q,
                    rotation: e.getRotation(this.endpoints[1].elementId)
    ...
    function () {
        ...
        c.AnchorManager = function (a) {
            var d = {},
                ...
                l = function (a, b, c, d, e, f, g, h) {
                    for (var i = [], j = b[e ? 0 : 1] / (d.length + 1), k = 0; k < d.length; k++) {
                        var l = (k + 1) * j,
                            m = f * b[e ? 1 : 0];
                        g && (l = b[e ? 0 : 1] - l);
                        var n = e ? l : m,
                            ...
                            s = q / b[1];
                        if (0 !== h) {
                            var t = jsPlumbUtil.rotatePoint([o, r], [c.centerx, c.centery], h);
                            o = t[0], r = t[1]
                        }
                        i.push([o, r, p, s, d[k][1], d[k][2]])
                    }
                    return i
                },
                m = function (a, b) {
                ...
                q = function (a, b) {
                    var c = j.getCachedData(a),
                        d = c.s,
                        g = c.o,
                        h = function (b, c, d, g, h, i, k) {
                            if (g.length > 0)
                                for (var m = p(g, o[b]), n = "right" === b || "top" === b, q = j.getRotation(a), r = l(b, c, d, m, h, i, n, q), s = function (a, b) {
                                    e[a.id] = [b[0], b[1], b[2], b[3]], f[a.id] = k
                                }, t = 0; t < r.length; t++) {
                                    var u = r[t][4],
                                        v = u.endpoints[0].elementId === a,
                                        w = u.endpoints[1].elementId === a;
                                    v && s(u.endpoints[0], r[t]), w && s(u.endpoints[1], r[t])
                                }
                        };
                    h("bottom", d, g, b.bottom, !0, 1, [0, 1]), h("top", d, g, b.top, !0, 0, [0, -1]), h("left", d, g, b.left, !1, 0, [-1, 0]), h("right", d, g, b.right, !1, 1, [1, 0])
                };
            this.reset = function () {
                d = {}, g = {}, i = {}
            ...
            this.sourceOrTargetChanged = function (a, d, e, f, h) {
                if (0 === h) {
                    if (a !== d) {
                        e.sourceId = d, e.source = f, b.removeWithFunction(g[a], function (a) {
                            return a[0].id === e.id
                        });
                        var i = b.findWithFunction(g[e.targetId], function (a) {
                            return a[0].id === e.id
                        });
                        i > -1 && (g[e.targetId][i][0] = e, g[e.targetId][i][1] = e.endpoints[0], g[e.targetId][i][2] = e.endpoints[0].anchor.constructor === c.DynamicAnchor), b.addToList(g, d, [e, e.endpoints[1], e.endpoints[1].anchor.constructor === c.DynamicAnchor]), e.endpoints[1].anchor.isContinuous && (e.source === e.target ? e._jsPlumb.instance.removeElement(e.endpoints[1].canvas) : null == e.endpoints[1].canvas.parentNode && e._jsPlumb.instance.appendElement(e.endpoints[1].canvas)), e.updateConnectedClass()
                    }
                } else if (1 === h) {
                    var j = e.endpoints[0].elementId;
                    e.target = f, e.targetId = d;
                    var k = b.findWithFunction(g[j], function (a) {
                        return a[0].id === e.id
                    }),
                        l = b.findWithFunction(g[a], function (a) {
                            return a[0].id === e.id
                        }); - 1 !== k && (g[j][k][0] = e, g[j][k][1] = e.endpoints[1], g[j][k][2] = e.endpoints[1].anchor.constructor === c.DynamicAnchor), l > -1 && (g[a].splice(l, 1), b.addToList(g, d, [e, e.endpoints[0], e.endpoints[0].anchor.constructor === c.DynamicAnchor])), e.updateConnectedClass()
                }
                ...
                for (var k = 0; k < a.connections.length; k++) a.connections[k].sourceId === b ? h.sourceOrTargetChanged(b, a.elementId, a.connections[k], a.element, 0) : a.connections[k].targetId === b && h.sourceOrTargetChanged(b, a.elementId, a.connections[k], a.element, 1)
                ...
                if (!j.isSuspendDrawing()) {
                    ...
                    for (var u = j.updateOffset({
                        ...
                        if (A || B) {
                            ...
                            var H = j.getCachedData(z),
                                I = j.getCachedData(y);
                            z === y && (A || B) ? (s(i[y], -Math.PI / 2, 0, x, !1, z, 0, !1, "top", y, n, o), s(i[z], -Math.PI / 2, 0, x, !1, y, 1, !1, "top", z, n, o)) : (D || (D = this.calculateOrientation(y, z, I.o, H.o, x.endpoints[0].anchor, x.endpoints[1].anchor, x, G, F), v[C] = D), A && s(i[y], D.theta, 0, x, !1, z, 0, !1, D.a[0], y, n, o), B && s(i[z], D.theta2, -1, x, !0, y, 1, !0, D.a[1], z, n, o)), A && b.addWithFunction(p, y, function (a) {
                                return a === y
                            }), B && b.addWithFunction(p, z, function (a) {
                                return a === z
                            }), b.addWithFunction(n, x, function (a) {
                                return a.id === x.id
                            }), (A && 0 === E || B && 1 === E) && b.addWithFunction(o, x.endpoints[E], function (a) {
                                return a.id === x.endpoints[E].id
                            })
                        }
                    }
                    for (w = 0; w < r.length; w++) 0 === r[w].connections.length && r[w].anchor.isContinuous && (i[a] || (i[a] = {
                        top: [],
                        right: [],
                        bottom: [],
                        left: []
                        ...
                        endpoints: [r[w], r[w]],
                        paint: function () { }
                    }, !1, a, 0, !1, r[w].anchor.getDefaultFace(), a, n, o), b.addWithFunction(p, a, function (b) {
                        return b === a
                    }));
                    for (w = 0; w < p.length; w++) q(p[w], i[p[w]]);
                    for (w = 0; w < r.length; w++) r[w].paint({
                        timestamp: f,
                        offset: u,
                        dimensions: u.s,
                        recalc: m !== !0
                    ...
                    for (w = 0; w < o.length; w++) {
                        var J = j.getCachedData(o[w].elementId);
                        o[w].paint({
                            timestamp: null,
                            offset: J,
                            dimensions: J.s
                    ...
                    for (w = 0; w < t.length; w++) {
                        var K = t[w][1];
                        if (K.anchor.constructor === c.DynamicAnchor) {
                            K.paint({
                                elementWithPrecedence: a,
                                timestamp: f
                            }), b.addWithFunction(n, t[w][0], function (a) {
                                return a.id === t[w][0].id
                            });
                            for (var L = 0; L < K.connections.length; L++) K.connections[L] !== t[w][0] && b.addWithFunction(n, K.connections[L], function (a) {
                                return a.id === K.connections[L].id
                            })
                        } else b.addWithFunction(n, t[w][0], function (a) {
                            return a.id === t[w][0].id
                        })
                    }
                    var M = k[a];
            ...
            var t = function (a) {
                ...
                for (var c = a.faces || ["top", "right", "bottom", "left"], d = !(a.clockwise === !1), g = {}, h = {
                    ...
                    left: "bottom",
                    bottom: "right"
                }, k = d ? i : j, l = d ? j : i, m = a.cssClass || "", n = null, o = null, p = ["left", "right"], q = ["top", "bottom"], r = null, s = 0; s < c.length; s++) g[c[s]] = !0;
        ...
        }, c.AnchorManager.prototype.calculateOrientation = function (a, b, c, d, e, f, g, h, i) {
            var j = {
            ...
            if (a === b) return {
                orientation: j.IDENTITY,
                a: ["top", "top"]
            };
            var l = Math.atan2(d.centery - c.centery, d.centerx - c.centerx),
                m = Math.atan2(c.centery - d.centery, c.centerx - d.centerx),
                n = [],
                o = {};
            ! function (a, b) {
                for (var c = 0; c < a.length; c++)
                    if (o[a[c]] = {
                        left: [b[c][0].left, b[c][0].centery],
                        right: [b[c][0].right, b[c][0].centery],
                        top: [b[c][0].centerx, b[c][0].top],
                        bottom: [b[c][0].centerx, b[c][0].bottom]
                    }, 0 !== b[c][1])
                        for (var d in o[a[c]]) o[a[c]][d] = jsPlumbUtil.rotatePoint(o[a[c]][d], [b[c][0].centerx, b[c][0].centery], b[c][1])
            }(["source", "target"], [
                [c, h],
                [d, i]
            ]);
            for (var p = 0; p < k.length; p++)
                for (var q = 0; q < k.length; q++) n.push({
                    source: k[p],
                    target: k[q],
                    dist: Biltong.lineLength(o.source[k[p]], o.target[k[q]])
                });
            n.sort(function (a, b) {
                return a.dist < b.dist ? -1 : a.dist > b.dist ? 1 : 0
            });
            for (var r = n[0].source, s = n[0].target, t = 0; t < n.length && (r = e.isContinuous && e.locked ? e.getCurrentFace() : !e.isContinuous || e.isEdgeSupported(n[t].source) ? n[t].source : null, s = f.isContinuous && f.locked ? f.getCurrentFace() : !f.isContinuous || f.isEdgeSupported(n[t].target) ? n[t].target : null, null == r || null == s); t++);
            return e.isContinuous && e.setCurrentFace(r), f.isContinuous && f.setCurrentFace(s), {
                a: [r, s],
                theta: l,
                theta2: m
            }
        }, c.Anchor = function (a) {
            this.x = a.x || 0, this.y = a.y || 0, this.elementId = a.elementId, this.cssClass = a.cssClass || "", this.orientation = a.orientation || [0, 0], this.lastReturnValue = null, this.offsets = a.offsets || [0, 0], this.timestamp = null, this._unrotatedOrientation = [this.orientation[0], this.orientation[1]], this.relocatable = a.relocatable !== !1, this.snapOnRelocate = a.snapOnRelocate !== !1, this.locked = !1, b.EventGenerator.apply(this), this.compute = function (a) {
                var b = a.xy,
                    c = a.wh,
                    d = a.timestamp;
                if (d && d === this.timestamp) return this.lastReturnValue;
                var e = [b[0] + this.x * c[0] + this.offsets[0], b[1] + this.y * c[1] + this.offsets[1], this.x, this.y],
                    f = a.rotation;
                if (null != f && 0 !== f) {
                    var g = jsPlumbUtil.rotatePoint(e, [b[0] + c[0] / 2, b[1] + c[1] / 2], f);
                    this.orientation[0] = Math.round(this._unrotatedOrientation[0] * g[2] - this._unrotatedOrientation[1] * g[3]), this.orientation[1] = Math.round(this._unrotatedOrientation[1] * g[2] + this._unrotatedOrientation[0] * g[3]), this.lastReturnValue = [g[0], g[1], this.x, this.y]
                } else this.orientation[0] = this._unrotatedOrientation[0], this.orientation[1] = this._unrotatedOrientation[1], this.lastReturnValue = e;
                return this.timestamp = d, this.lastReturnValue
            }, this.getCurrentLocation = function (a) {
                ...
                (!this.locked || e) && (this.x = a, this.y = b, this.orientation = [c, d], this.lastReturnValue = null)
            }
        ...
        c.DynamicAnchor = function (a) {
            ...
            var e = this.anchors.length > 0 ? this.anchors[0] : null,
                ...
                g = function (a, b, c, d, e, f, g) {
                    var h = d[0] + a.x * e[0],
                        ...
                        k = d[1] + e[1] / 2;
                    if (null != f && 0 !== f) {
                        var l = jsPlumbUtil.rotatePoint([h, i], [j, k], f);
                        h = l[0], i = l[1]
                    }
                    return Math.sqrt(Math.pow(b - h, 2) + Math.pow(c - i, 2)) + Math.sqrt(Math.pow(j - h, 2) + Math.pow(k - i, 2))
                },
                h = a.selector || function (a, b, c, d, e, f, h) {
                    for (var i = c[0] + d[0] / 2, j = c[1] + d[1] / 2, k = -1, l = 1 / 0, m = 0; m < h.length; m++) {
                        var n = g(h[m], i, j, a, b, e, f);
                        l > n && (k = m + 0, l = n)
                    }
                    return h[k]
                };
            this.compute = function (a) {
                var b = a.xy,
                    ...
                    i = a.rotation,
                    j = a.tRotation;
                return this.timestamp = a.timestamp, this.locked || null == d || null == g ? (this.lastReturnValue = e.compute(a), this.lastReturnValue) : (a.timestamp = null, e = h(b, c, d, g, i, j, this.anchors), this.x = e.x, this.y = e.y, e !== f && this.fire("anchorChanged", e), f = e, this.lastReturnValue = e.compute(a), this.lastReturnValue)
            }, this.getCurrentLocation = function (a) {
                return null != e ? e.getCurrentLocation(a) : null
            }, this.getOrientation = function (a) {
        ...
        c.Anchors.Continuous = function (a) {
            ...
            var d = function () {
                ...
                e = function (a) {
                    for (var c = b / a.length, d = [], e = function (a, e, f, g, h, i, j) {
                        c = b * h;
                        for (var k = (f - a) / c, l = (g - e) / c, m = 0; c > m; m++) d.push([a + k * m, e + l * m, null == i ? 0 : i, null == j ? 0 : j])
                    }, f = 0; f < a.length; f++) e.apply(null, a[f]);
                    return d
                },
                f = function (a) {
                    for (var b = [], c = 0; c < a.length; c++) b.push([a[c][0], a[c][1], a[c][2], a[c][3], 1 / a.length, a[c][4], a[c][5]]);
                    return e(b)
                },
                g = function () {
                    return f([
    ...
    function () {
        "use strict";
        var a = this,
            b = (a.jsPlumbUtil, a.jsPlumb);
        b.DefaultRouter = function (a) {
            this.jsPlumbInstance = a, this.anchorManager = new b.AnchorManager({
                jsPlumbInstance: a
            }), this.sourceOrTargetChanged = function (a, b, c, d, e) {
                this.anchorManager.sourceOrTargetChanged(a, b, c, d, e)
            }, this.reset = function () {
                this.anchorManager.reset()
            }, this.changeId = function (a, b) {
                this.anchorManager.changeId(a, b)
            }, this.elementRemoved = function (a) {
                this.anchorManager.elementRemoved(a)
            }, this.newConnection = function (a) {
                this.anchorManager.newConnection(a)
            }, this.connectionDetached = function (a, b) {
                this.anchorManager.connectionDetached(a, b)
            }, this.redraw = function (a, b, c, d, e, f) {
                return this.anchorManager.redraw(a, b, c, d, e, f)
            }, this.deleteEndpoint = function (a) {
                this.anchorManager.deleteEndpoint(a)
            }, this.rehomeEndpoint = function (a, b, c) {
                this.anchorManager.rehomeEndpoint(a, b, c)
            }, this.addEndpoint = function (a, b) {
                this.anchorManager.addEndpoint(a, b)
            }
        }
    }.call("undefined" != typeof window ? window : this),
    function () {
            ...
            Straight: function (a) {
                ...
                this.lineIntersection = function (a, b, c, f) {
                    ...
                    if (k !== l)
                        ...
                        else if (0 === k && l === 1 / 0) o(b, i, j) && o(g, a, c) && (n = [g, b]);
                        else {
                            var q, r;
            ...
            Bezier: function (c) {
                ...
                var d = function (a) {
                    ...
                    f = function (a) {
                        ...
                        if (0 === a) return this.curve[0];
                        var c = this.curve.length - 1;
                        if (1 === a) return this.curve[c];
                        var d = this.curve,
                            e = 1 - a;
                        if (0 === c) return this.curve[0];
                        if (1 === c) return {
                            x: e * d[0].x + a * d[1].x,
                            y: e * d[0].y + a * d[1].y
                        };
                        if (4 > c) {
                            var f, g, h, i = e * e,
                                j = a * a,
                                k = 0;
                            return 2 === c ? (d = [d[0], d[1], d[2], b], f = i, g = 2 * (e * a), h = j) : 3 === c && (f = i * e, g = 3 * (i * a), h = 3 * (e * j), k = a * j), {
                                x: f * d[0].x + g * d[1].x + h * d[2].x + k * d[3].x,
                                y: f * d[0].y + g * d[1].y + h * d[2].y + k * d[3].y
                            }
                        }
                        return b
                    }.bind(this),
                    g = function (a) {
                        var b = [];
                        a--;
                        for (var c = 0; a >= c; c++) b.push(f(c / a));
                        return b
                    },
                    h = function () {
                        d(this.curve) && (this.length = 0);
                        var a = 16,
                            b = g(a);
                        this.length = 0;
                        for (var c = 0; a - 1 > c; c++) {
                ...
                this.pointOnPath = function (b, c) {
                    return b = i(this.curve, b, c), a.jsBezier.pointOnCurve(this.curve, b)
                }, this.gradientAtPoint = function (b, c) {
                    return b = i(this.curve, b, c), a.jsBezier.gradientAtPoint(this.curve, b)
                }, this.pointAlongPathFrom = function (b, c, d) {
                    return b = i(this.curve, b, d), a.jsBezier.pointAlongCurveFrom(this.curve, b, c)
                }, this.getLength = function () {
                    return this.length
                }, this.getBounds = function () {
                    return this.bounds
        ...
        b.Connectors.AbstractConnector = function (a) {
            ...
            this.getPathData = function () {
                ...
                for (var b = [], c = 0; c < f.length; c++) b.push.apply(b, f[c].boundingBoxIntersection(a));
                return b
            };
            var r = function () {
                ...
                s = function (a, b) {
                    var c, d, e;
                    if (b && (a = a > 0 ? a / g : (g + a) / g), 1 === a) c = f.length - 1, e = 1;
                    else if (0 === a) e = 0, c = 0;
                    else if (a >= .5) {
                        for (c = 0, e = 0, d = h.length - 1; d > -1; d--)
                            if (h[d][1] >= a && h[d][0] <= a) {
                                c = d, e = (a - h[d][0]) / i[d];
                                break
                            }
                    } else
                        for (c = h.length - 1, e = 1, d = 0; d < h.length; d++)
                            if (h[d][1] >= a) {
                                c = d, e = (a - h[d][0]) / i[d];
                                break
                            } return {
            ...
            return this.pointOnPath = function (a, b) {
                ...
                q = v.call(this, a), u(), this._compute(q, a), this.x = q.points[0], this.y = q.points[1],
                    this.w = q.points[2], this.h = q.points[3], this.segment = q.segment, r()
            }, {
                addSegment: t,
                prepareCompute: v,
                sourceStub: k,
    ...
    function () {
        ...
        var a = this,
            ...
            z = function (a) {
                function c(b, c) {
                    for (var d = a.getContainer(), e = !1; !e;) {
                        if (null == b || b === d) return !1;
                        if (b === c) return !0;
                        b = b.parentNode
                    }
                }
                ...
                function f(a) {
                    ...
                    null != d && (c = function (b) {
                        return b.id === a.id
                    }, b.removeWithFunction(d.connections.source, c), b.removeWithFunction(d.connections.target, c), delete j[a.id]), d = l[a.id], null != d && (c = function (b) {
                        return b.id === a.id
                    }, b.removeWithFunction(d.connections.source, c), b.removeWithFunction(d.connections.target, c), delete l[a.id])
                }

                function g(b, c) {
                    for (var d = b.getEl().querySelectorAll(".jtk-managed"), e = 0; e < d.length; e++) a[c ? x : y](d[e], !0)
                }

                function h(b) {
                    for (var c = b.getMembers().slice(), d = [], e = 0; e < c.length; e++) Array.prototype.push.apply(d, c[e].querySelectorAll(".jtk-managed"));
                    Array.prototype.push.apply(c, d);
                    var f = a.getConnections({
                        source: c,
                        scope: "*"
                    }, !0),
                        g = a.getConnections({
                    ...
                    var i = function (c) {
                        for (var d = 0; d < c.length; d++)
                            if (!h[c[d].id]) {
                                h[c[d].id] = !0;
                                var e = a.getGroupFor(c[d].source),
                                    f = a.getGroupFor(c[d].target);
                                e === b ? (f !== b && b.connections.source.push(c[d]), j[c[d].id] = b) : f === b && (b.connections.target.push(c[d]), l[c[d].id] = b)
                            }
                    };
                    i(f), i(g)
                }
                var i = {},
                    ...
                    l = {},
                    n = this;
                a.bind("connection", function (c) {
                    var d = a.getGroupFor(c.source),
                        e = a.getGroupFor(c.target);
                    null != d && null != e && d === e ? (j[c.connection.id] = d, l[c.connection.id] = d) : (null != d && (b.suggest(d.connections.source, c.connection), j[c.connection.id] = d), null != e && (b.suggest(e.connections.target, c.connection), l[c.connection.id] = e))
                }), a.bind(u, function (a) {
                    f(a.connection)
                }), a.bind(t, function (a) {
                    var b = 0 === a.index ? j : l,
                    ...
                    a.addClass(b.getEl(), e), i[b.id] = b, b.manager = this, h(b), a.fire(o, {
                        group: b
                    })
                    ...
                    if (b = this.getGroup(b)) {
                        ...
                        if (f !== b) {
                            ...
                            null != f && (f.remove(c, !1, d, !1, b), n.updateConnectionsForGroup(f)), b.add(c, d);
                            var i = function (a, c) {
                                var d = 0 === c ? 1 : 0;
                                a.each(function (a) {
                                    a.setVisible(!1), a.endpoints[d].element._jsPlumbGroup === b ? (a.endpoints[d].setVisible(!1), z(a, d, b)) : (a.endpoints[c].setVisible(!1), s(a, c, b))
                                })
                            };
                            ...
                            if (a.setPosition(c, k), a.dragManager.revalidateParent(c, j, g), n.updateConnectionsForGroup(b), a.revalidate(j), !d) {
                                var l = {
                                    group: b,
                                    el: c,
                                    pos: k
                                };
                                f && (l.sourceGroup = f), a.fire(m, l)
                            }
                        }
                    }
                }, this.removeFromGroup = function (a, b, d) {
                        ...
                        if (a.collapsed) {
                            var e = function (d, e) {
                                for (var f = 0; f < d.length; f++) {
                                    var g = d[f];
                                    if (g.proxies)
                                        for (var h = 0; h < g.proxies.length; h++)
                                            if (null != g.proxies[h]) {
                                                var i = g.proxies[h].originalEp.element;
                                                (i === b || c(i, b)) && z(g, e, a)
                                            }
                                }
                            };
                            e(a.connections.source.slice(), 0), e(a.connections.target.slice(), 1)
                        }
                        a.remove(b, null, d)
                    }
                }, this.getGroup = function (a) {
                    var c = a;
                    if (b.isString(a) && (c = i[a], null == c)) throw new TypeError("No such group [" + a + "]");
                    return c
                }, this.getGroups = function () {
                    var a = [];
                    for (var b in i) a.push(i[b]);
                    return a
                }, this.removeGroup = function (b, c, d, e) {
                    b = this.getGroup(b), this.expandGroup(b, !0);
                    var f = b[c ? v : w](d, e);
                    return a.remove(b.getEl()), delete i[b.id], delete a._groups[b.id], a.fire(p, {
                        group: b
                    }), f
                }, this.removeAllGroups = function (a, b, c) {
                    for (var d in i) this.removeGroup(i[d], a, b, c)
                };
                ...
                this.collapseGroup = function (b) {
                    if (b = this.getGroup(b), null != b && !b.collapsed) {
                        ...
                        if (g(b, !1), b.shouldProxy()) {
                            ...
                            f(b.connections.source, 0), f(b.connections.target, 1)
                        }
                ...
                this.expandGroup = function (b, c) {
                    if (b = this.getGroup(b), null != b && b.collapsed) {
                        ...
                        b.collapsed = !1, a.addClass(f, e), a.removeClass(f, d), a.revalidate(f), this.repaintGroup(b), c || a.fire(q, {
                            group: b
                        })
                    }
                ...
                }, this.updateConnectionsForGroup = h, this.refreshAllGroups = function () {
                    for (var b in i) h(i[b]), a.dragManager.updateOffsets(a.getId(i[b].getEl()))
                }
            },
            A = function (c, d) {
                function e(a) {
                ...
                function o(a) {
                    ...
                    for (var d = [], e = 0; e < a.selection.length; e++) d.push(b(a.selection[e][0], a.selection[e][1].left, a.selection[e][1].top));
                ...
                if (this.connections = {
                    ...
                    var E = {
                        drag: function () {
                            for (var a = 0; a < D.length; a++) c.draw(D[a])
                        },
                        stop: function (a) {
        ...
        c.prototype.addGroup = function (a) {
            ...
            this.getGroupManager().removeFromGroup(a, b, c), this.getContainer().appendChild(b)
            ...
            if (a = this.getElement(a)) {
                for (var b = this.getContainer(), c = !1, d = null, e = null; !c;) null == a || a === b ? c = !0 : a[k] ? (d = a[k], e = a, c = !0) : a = a.parentNode;
                return d
            }
        }
    }.call("undefined" != typeof window ? window : this),
        ...
        var a = this,
            ...
            f = function (a) {
                ...
                var c, f, g = b.Connectors.AbstractConnector.apply(this, arguments),
                    h = null == a.midpoint || isNaN(a.midpoint) ? .5 : a.midpoint,
                ...
                this.midpoint = h, this._compute = function (a, b) {
    ...
    function () {
            ...
            return this.getDisplayElements = function () {
                ...
                if (null != b) {
                    var g, h = [this.x, this.y],
                        i = [this.w, this.h];
                    null != f && (f.xmin < 0 && (h[0] += f.xmin), f.ymin < 0 && (h[1] += f.ymin), i[0] = f.xmax + (f.xmin < 0 ? -f.xmin : 0), i[1] = f.ymax + (f.ymin < 0 ? -f.ymin : 0)), a.useDivWrapper ? (c.sizeElement(this.canvas, h[0], h[1], i[0] > 0 ? i[0] : 1, i[1] > 0 ? i[1] : 1), h[0] = 0, h[1] = 0, g = u([0, 0])) : g = u([h[0], h[1]]), e.paint.apply(this, arguments), s(this.svg, {
                        style: g,
                        width: i[0] || 1,
                        height: i[1] || 1
                    })
        ...
        c.extend(B, [b.jsPlumbUIComponent, b.Overlays.AbstractOverlay]), b.Overlays.svg.Arrow = function () {
            B.apply(this, [b.Overlays.Arrow, arguments])
        }, c.extend(b.Overlays.svg.Arrow, [b.Overlays.Arrow, B], C), b.Overlays.svg.PlainArrow = function () {
            B.apply(this, [b.Overlays.PlainArrow, arguments])
        }, c.extend(b.Overlays.svg.PlainArrow, [b.Overlays.PlainArrow, B], C), b.Overlays.svg.Diamond = function () {
            B.apply(this, [b.Overlays.Diamond, arguments])
        }, c.extend(b.Overlays.svg.Diamond, [b.Overlays.Diamond, B], C), b.Overlays.svg.GuideLines = function () {
            var a, c, d = null,
                e = this;
    ...
    function () {
        ...
        var a = this,
            ...
            j = function (a) {
                for (var b, c = a.selection, d = function (c) {
                    var d;
                    null != c[1] && (b = this.getUIPosition([{
                        el: c[2].el,
                        pos: [c[1].left, c[1].top]
                    }]), d = this.draw(c[2].el, b)), null != c[0]._jsPlumbDragOptions && delete c[0]._jsPlumbDragOptions._dragging, this.removeClass(c[0], "jtk-dragged"), this.select({
                        source: c[2].el
                    }).removeClass(this.elementDraggingClass + " " + this.sourceElementDraggingClass, !0), this.select({
                        target: c[2].el
                    }).removeClass(this.elementDraggingClass + " " + this.targetElementDraggingClass, !0), a.e._drawResult = a.e._drawResult || {
                        c: [],
                        e: [],
                        a: []
                    }, Array.prototype.push.apply(a.e._drawResult.c, d.c), Array.prototype.push.apply(a.e._drawResult.e, d.e), Array.prototype.push.apply(a.e._drawResult.a, d.a), this.getDragManager().dragEnded(c[2].el)
                }.bind(this), e = 0; e < c.length; e++) d(c[e]);
        ...
        a.jsPlumb.extend(a.jsPlumbInstance.prototype, {
            ...
            destroyDraggable: function (a, b) {
                g(this, b).destroyDraggable(a), a._jsPlumbDragOptions = null, a._jsPlumbRelatedElement = null
            },
            ...
            _initDraggableIfNecessary: function (a, b, d, e, f) {
                if (!jsPlumb.headless) {
                    ...
                    if (g && jsPlumb.isDragSupported(a, this)) {
                        ...
                        if (k = jsPlumb.extend({}, k), jsPlumb.isAlreadyDraggable(a, this)) d.force && this.initDraggable(a, k);
                        else {
            ...
            getElement: function (a) {
                return null == a ? null : (a = "string" == typeof a ? a : null == a.tagName && null != a.length && null == a.enctype ? a[0] : a, "string" == typeof a ? document.getElementById(a) : a)
            },
